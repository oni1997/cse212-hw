public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: Was accessing wrong index in Dequeue method
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Enqueue was inserting at wrong position (index 0 instead of end)
        ...
        // Defect(s) Found: Was accessing invalid index when queue was empty
    }
    ...
    private void Enqueue(int value) {
        _queue.Add(value);  // Changed from Insert(0, value) to Add(value)
    }
    ...
    private int Dequeue() {
        ...
        var value = _queue[0];  // Changed from _queue[1] to _queue[0]
        _queue.RemoveAt(0);     // Changed from RemoveAt(1) to RemoveAt(0)
        return value;
    }
}